...
// Extracted from CLI traces.rs — the LLM must reproduce this exactly.
// ---------------------------------------------------------------------------

const COVAL_TRACING_PY = `# coval_tracing.py — generated by coval wizard
#
...
Below is the complete \`coval_tracing.py\` module. Generate this file exactly as shown — do NOT modify it.
